package com.huatu.ehr.web.util;
...
public class ImageValidateUtil {
	...
	public static BufferedImage outputImage(int w, int h, String code) throws IOException {
		...
		int fontSize = h - 4;
		Font font = new Font("Fixedsys", Font.CENTER_BASELINE, fontSize);
		g2.setFont(font);
	...
	public static Object[] generateCodeImg() throws Exception {
		int w = 200, h = 80;
		String verifyCode = generateVerifyCode(4);
		BufferedImage image = outputImage(w, h, verifyCode);
		return new Object[] { verifyCode, image };
	}
